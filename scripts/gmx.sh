#! /bin/bash
echo 3 | gmx pdb2gmx -f 6M0J_fixed.pdb -o name_processed.gro -water tip3p -ignh
...
echo 13 | gmx genion -s ions.tpr -o name_solv_ions.gro -p topol.top -pname NA -nname CL -neutral#
